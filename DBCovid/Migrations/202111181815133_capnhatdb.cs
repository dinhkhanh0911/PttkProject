namespace DBCovid.Migrations
{
    ...
    public partial class capnhatdb : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.tbl_ThongTinDieuTris", "nhanVienYTeID");
            CreateIndex("dbo.tbl_BenhAns", "phongBenhID");
            AddForeignKey("dbo.tbl_ThongTinDieuTris", "nhanVienYTeID", "dbo.Tbl_NhanVienYTes", "ID", cascadeDelete: true);
            AddForeignKey("dbo.tbl_BenhAns", "phongBenhID", "dbo.tbl_PhongBenhs", "ID", cascadeDelete: true);
        }
    }
}
